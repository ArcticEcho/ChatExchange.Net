...
namespace Example
{
	public class Example
	{
		static void Main()
		{
			Console.WriteLine("This is a ChatExchange.Net demonstartion. Press the 'Q' key to exit...\n\n");
			...
			// Posts a new message in the room (if sucessful, returns a Message object, otherwise returns null).
			...
			{
				var success = sandbox.PostMessage("Welcome " + user.Name + "!");
