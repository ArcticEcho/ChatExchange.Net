...
namespace ChatExchangeDotNet
{
    ...
    public class Room : IDisposable
    {
		...
		/// <summary>
		/// How long to wait since last receiving data before restarting the websocket.
		/// </summary>
		public TimeSpan WebSocketIdleTimeOut
		{
			get
			{
				return socket?.IdlePeriod ?? TimeSpan.MinValue;
			}
			set
			{
				socket.IdlePeriod = value;
			}
		}
        ...
        private void InitialiseSocket(string socketUrl)
        {
            ...
            socket.Connect(socketUrl, "https://chat." + Meta.Host);
        }
